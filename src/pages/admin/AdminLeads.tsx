...
import {
  Search, Trash2, Pencil, UserCheck,
  Phone, Mail, MapPin, Calendar, AlertCircle,
  Building2, Stethoscope, Briefcase, Users,
...
const AdminLeads = () => {
  ...
  // Fetch all leads with linked case info
                  ...
                  <TableRow key={lead.id} className="hover:bg-secondary/30 transition-colors">
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1">
                        {/* View linked case — for converted leads */}
                        {lead.crm_status === "converted" && lead.linked_case && (
                          <button
                            onClick={() => navigate(`/admin/cases/${lead.linked_case!.id}`)}
