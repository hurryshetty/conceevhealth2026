...
import { LayoutDashboard, FolderKanban, Users, LogOut, Building2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex">
      <aside className="w-60 border-r border-border bg-card flex flex-col">
        <div className="p-5 border-b border-border flex items-center gap-2">
          ...
          <span className="text-xs bg-primary/10 text-primary px-2 py-0.5 rounded-full ml-auto">Hospital</span>
        </div>
